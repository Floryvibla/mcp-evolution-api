...
export class EvolutionAPI {
  ...
  // Business API
  async updateBusinessProfile(instanceName: string, data: any): Promise<any> {
    const response = await this.client.put(`/business/profile/${instanceName}`, data);
    return response.data;
  }

  async getBusinessHours(instanceName: string): Promise<any> {
    const response = await this.client.get(`/business/hours/${instanceName}`);
    return response.data;
  }

  async updateBusinessHours(instanceName: string, data: any): Promise<any> {
    const response = await this.client.put(`/business/hours/${instanceName}`, data);
    return response.data;
  }

  async getBusinessCatalog(instanceName: string): Promise<any> {
    const response = await this.client.get(`/business/catalog/${instanceName}`);
    return response.data;
  }

  async createBusinessCatalogProduct(instanceName: string, data: any): Promise<any> {
    const response = await this.client.post(`/business/catalog/${instanceName}`, data);
    return response.data;
  }

  async updateBusinessCatalogProduct(instanceName: string, productId: string, data: any): Promise<any> {
    const response = await this.client.put(`/business/catalog/${instanceName}/${productId}`, data);
    return response.data;
  }

  async deleteBusinessCatalogProduct(instanceName: string, productId: string): Promise<any> {
    const response = await this.client.delete(`/business/catalog/${instanceName}/${productId}`);
    return response.data;
  }

  // Settings API
  async getSettings(instanceName: string): Promise<any> {
    const response = await this.client.get(`/settings/get/${instanceName}`);
    return response.data;
  }

  async updateSettings(instanceName: string, data: any): Promise<any> {
    const response = await this.client.put(`/settings/update/${instanceName}`, data);
    return response.data;
  }

  async setPrivacySettings(instanceName: string, data: any): Promise<any> {
    const response = await this.client.put(`/settings/privacy/${instanceName}`, data);
    return response.data;
  }

  // Labels API
  async getLabels(instanceName: string): Promise<any[]> {
    const response = await this.client.get(`/labels/get/${instanceName}`);
    return response.data;
  }

  async createLabel(instanceName: string, data: any): Promise<any> {
    const response = await this.client.post(`/labels/create/${instanceName}`, data);
    return response.data;
  }

  async updateLabel(instanceName: string, labelId: string, data: any): Promise<any> {
    const response = await this.client.put(`/labels/update/${instanceName}/${labelId}`, data);
    return response.data;
  }

  async deleteLabel(instanceName: string, labelId: string): Promise<any> {
    const response = await this.client.delete(`/labels/delete/${instanceName}/${labelId}`);
    return response.data;
  }

  async addLabelToChat(instanceName: string, data: any): Promise<any> {
    const response = await this.client.post(`/labels/addToChat/${instanceName}`, data);
    return response.data;
  }

  async removeLabelFromChat(instanceName: string, data: any): Promise<any> {
    const response = await this.client.delete(`/labels/removeFromChat/${instanceName}`, { data });
    return response.data;
  }

  // Call API
  async getCallHistory(instanceName: string): Promise<any[]> {
    const response = await this.client.get(`/call/history/${instanceName}`);
    return response.data;
  }
